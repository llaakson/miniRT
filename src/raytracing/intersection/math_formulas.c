...
/*   Updated: 2025/04/27 15:13:10 by aalbrech         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t stands for where on the ray we are.
If t is more than 0, the ray hits the object.
(
...
Ideally, one where the ray enters the object,
and one where the ray exits the object.
...
-1 if both the intersections
are behind the camera. We can't see them in the scene.
Else the smaller of the two t values,
which means the hit is closer to the camera.
